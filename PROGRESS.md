...
## Status
In progress. 50 of 98 chapters written. Parts I, II, III, IV, V, and VI
are all complete.

## Next chapter due
Part VII, Chapter 7.4 — Classification vs. Detection vs. Segmentation
(parts/part-07-teaching-computers-to-see.html already exists — insert the
new <section> before </main> and flip 7.4's sidebar entry from unwritten
